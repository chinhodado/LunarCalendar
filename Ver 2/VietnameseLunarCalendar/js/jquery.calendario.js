...
var ABOUT = "Âm l?ch Vi?t Nam - Version 0.8" + "\n© 2004 H? Ng?c ??c [http://come.to/duc]";
var TK19 = new Array(
...
var CAN = new Array("Giáp", "?t", "Bính", "?inh", "M?u", "K?", "Canh", "Tân", "Nhâm", "Quý");
var CHI = new Array("Tý", "S?u", "D?n", "Mão", "Thìn", "T?", "Ng?", "Mùi", "Thân", "D?u", "Tu?t", "H?i");
var TUAN = new Array("Ch? nh?t", "Th? hai", "Th? ba", "Th? t?", "Th? n?m", "Th? sáu", "Th? b?y");
var GIO_HD = new Array("110100101100", "001101001011", "110011010010", "101100110100", "001011001101", "010010110011");
var TIETKHI = new Array("Xuân phân", "Thanh minh", "C?c v?", "L?p h?", "Ti?u mãn", "Mang ch?ng",
	"H? chí", "Ti?u th?", "??i th?", "L?p thu", "X? th?", "B?ch l?",
	"Thu phân", "Hàn l?", "S??ng giáng", "L?p ?ông", "Ti?u tuy?t", "??i tuy?t",
	"?ông chí", "Ti?u hàn", "??i hàn", "L?p xuân", "V? Th?y", "Kinh tr?p"
);
...
function getDayName(lunarDate) {
    ...
    var s = "Ngày " + cc[0] + ", tháng " + cc[1] + ", n?m " + cc[2];
    return s;
}
...
function getDayInfo(dd, mm, yy, leap, jd, sday, smonth, syear) {
    ...
    s += " âm l?ch\n";
    s += getDayName(lunar);
    s += "\nGi? ??u ngày: " + getCanHour0(jd) + " " + CHI[0];
    s += "\nTi?t: " + TIETKHI[getSunLongitude(jd + 1, 7.0)];
    s += "\nGi? hoàng ??o: " + getGioHoangDao(jd);
    return s;
}
